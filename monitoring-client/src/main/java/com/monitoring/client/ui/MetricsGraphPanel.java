...
public class MetricsGraphPanel extends JPanel {
    ...
    private static final int MAX_POINTS = 10; // 20 seconds / 2s = 10 points
    ...
    protected void paintComponent(Graphics g) {
        ...
        int width = getWidth();
        int height = getHeight() - 40; // Leave space for labels
        int padding = 30;

        // Draw grid and labels
        g2d.setColor(new Color(220, 220, 220)); // Light gray grid
    ...
    private void drawLine(Graphics2D g2d, List<Double> data, int width, int height, int padding, Color fillColor) {
        ...
        // Draw line
        g2d.setColor(g2d.getColor().darker().darker()); // Darker stroke
